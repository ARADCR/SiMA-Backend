...
/**
 * DTO para confirmar una toma de medicamento.
...
public class RegistroTomaRequest {
    ...
    @Pattern(regexp = "^(app|chatbot|iot_pastillero|manual_cuidador)$", message = "El método debe ser: app, chatbot, iot_pastillero o manual_cuidador")
